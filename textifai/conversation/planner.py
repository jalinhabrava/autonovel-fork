...
class TaskPlanner:
    def plan(
        ...
        mapping = {
            ...
            "search_context": ("context_lookup", "context_search_flow", True, False, True, False, ["resolve_target", "build_context", "return_response"]),
        ...
        return PlannedTask(
            ...
            target_id=intent.target_id or request.target_hint or (state.last_target_id if state else None),
            ephemeral=ephemeral,
            ...
            metadata={"intent_name": intent.intent_name},
        )
