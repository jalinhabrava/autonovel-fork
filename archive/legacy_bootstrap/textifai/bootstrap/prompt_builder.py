    ...
    return BootstrapPrompt(
        ...
        user_payload={
            ...
            "analysis_targets": [
                ...
                "classify_fragments",
                "identify_canonical_subjects_when_possible",
                "decide_if_each_fragment_should_stay_staged_or_can_be_promoted",
                "propose_editorial_titles_when_the_subject_is_clear",
