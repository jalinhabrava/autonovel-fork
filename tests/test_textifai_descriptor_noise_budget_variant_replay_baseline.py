...
class TextifAIDescriptorNoiseBudgetVariantReplayBaselineTests(unittest.TestCase):
    def test_replay_input_variant_structure_is_valid_and_safe(self):
    ...
    def test_provider_free_replay_writes_only_inside_temp_output(self):
        ...
        with tempfile.TemporaryDirectory(prefix="textifai_descriptor_noise_budget_variant_replay_") as temp_root:
